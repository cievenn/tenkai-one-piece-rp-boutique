      ...
      <div className="tk-scroll-zone" style={{ display: 'flex', flexDirection: 'column', width: '100%', alignItems: 'center', overflow: 'visible', zIndex: 2 }}>
        ...
        {user && (
          <div className="tk-player-avatar">
            <img src={displayAvatar} alt={user.displayName || user.discordUsername} style={{ borderRadius: '12px' }} />
            <div className="tk-status-dot online" />
            <div className="tk-player-tooltip">
              <div className="tk-tech-font" style={{ color: '#FFF', fontSize: '1.2rem' }}>{user.displayName || user.discordUsername}</div>
        ...
        <div style={{ textAlign: 'center', color: 'rgba(255,255,255,0.2)', fontSize: '0.65rem', fontFamily: 'Orbitron, sans-serif', letterSpacing: '1px' }}>v2.0</div>
      </div>
    </aside>
  );
}
