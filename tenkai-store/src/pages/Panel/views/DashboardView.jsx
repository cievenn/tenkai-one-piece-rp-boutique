  ...
  return (
    ...
    >
      ...
      <style dangerouslySetInnerHTML={{__html: `
        ...
        /* EFFETS INTERACTIFS DU HERO BANNER */
        .tk-hero-title-part {
          display: inline-block;
          transition: all 0.4s cubic-bezier(0.16, 1, 0.3, 1);
        }
        .tk-hero-title-part.tenkai:hover {
          transform: scale(1.05) translateY(-5px);
          filter: drop-shadow(0 0 25px rgba(255,255,255,0.8)) !important;
        }
        .tk-hero-title-part.op:hover {
          transform: scale(1.05) translateX(-2px) translateY(-5px) !important;
          filter: drop-shadow(0 0 35px rgba(0, 229, 255, 0.9)) drop-shadow(0 8px 10px rgba(0,0,0,0.8)) !important;
        }
        ...
        .tk-hero-img:hover {
          ...
          filter: drop-shadow(-25px 25px 40px rgba(0,0,0,0.9)) drop-shadow(0 0 35px rgba(0,229,255,0.6)) !important;
        }
        ...
        .tk-link-btn:hover { color: #00E5FF; transform: translateY(-2px); text-shadow: 0 0 10px rgba(0,229,255,0.4); }
        ...
        .tk-data-row { 
          ...
          border: 1px solid rgba(255,255,255,0.05); border-radius: 10px; padding: 8px 12px;
          flex-shrink: 0;
        }
        .tk-data-row::before {
        ...
        /* =========================================
           RÈGLES RESPONSIVES (MOBILES & TABLETTES)
           ========================================= */
        @media (max-width: 1200px) {
          /* Libère le scroll global et ajuste les paddings */
          .tk-responsive-root { overflow-y: auto !important; overflow-x: hidden !important; padding: 1.5rem !important; }
          
          /* Grille passe de 12 colonnes complexes à 2 colonnes simples */
          .tk-responsive-grid {
          ...
          /* Replacements logiques pour Tablette */
          .tk-card-hero { grid-column: 1 / -1 !important; grid-row: 1 !important; height: auto !important; min-height: 350px; }
          .tk-card-fortune { grid-column: 1 / 2 !important; grid-row: 2 !important; height: auto !important; min-height: 250px; }
          .tk-card-prime { grid-column: 2 / 3 !important; grid-row: 2 !important; height: auto !important; min-height: 250px; }
          .tk-card-mushi { grid-column: 1 / -1 !important; grid-row: 3 !important; height: auto !important; min-height: 350px; }
          
          .tk-hero-content { width: 80% !important; z-index: 20 !important; }
          .tk-fortune-content { width: 100% !important; z-index: 20 !important; }
        }

        @media (max-width: 768px) {
          /* Mode 100% Mobile */
          .tk-responsive-root { padding: 1rem !important; }
          .tk-responsive-grid { display: flex !important; flex-direction: column !important; }
          .tk-dash-card { padding: 1.2rem !important; }
          .tk-card-hero .tk-dash-card { padding: 1.5rem 1.2rem !important; }
          
          /* Ajustement des images pour ne pas gêner la lecture */
          .tk-hero-content { width: 100% !important; }
          .tk-hero-img { opacity: 0.25 !important; right: -15% !important; max-width: 80% !important; }
          .tk-oob-char { opacity: 0.25 !important; right: -10% !important; max-width: 80% !important; }
          
          /* Réduction proportionnelle des gros titres */
          .tk-hero-title-part.tenkai { font-size: 2rem !important; letter-spacing: 4px !important; }
          .tk-hero-title-part.op { font-size: 2.8rem !important; }
          
          /* Boutons pleine largeur */
          .tk-hero-actions { flex-direction: column !important; align-items: stretch !important; gap: 10px !important; }
          .tk-hero-actions > button { width: 100%; justify-content: center; }
          .tk-hero-actions > div { width: 100%; margin-left: 0 !important; justify-content: space-between; box-sizing: border-box; }
        }
      `}} />

      <div className="tk-grid-container tk-responsive-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(12, 1fr)', gridTemplateRows: 'minmax(0, 1.4fr) minmax(0, 1.2fr)', gap: '1.5rem', height: '100%', overflow: 'visible' }}>
        
        {/* =========================================
            1. HERO BANNER
        ========================================= */}
        <motion.div variants={cardVariants} className="tk-card-hero" style={{ gridColumn: '1 / span 8', gridRow: '1', position: 'relative', height: '100%' }}>
          <div className="tk-dash-card" style={{ height: '100%', padding: '1.8rem 2.5rem', display: 'flex', alignItems: 'center' }}>
            ...
            <div className="tk-hero-content" style={{ position: 'relative', zIndex: 15, width: '65%', display: 'flex', flexDirection: 'column', gap: '0.8rem', marginTop: '0.5rem' }}>
              ...
              <div style={{ position: 'relative' }}>
                ...
                <h1 style={{ display: 'flex', flexDirection: 'column', margin: 0, position: 'relative', zIndex: 2 }}>
                  <span className="tk-hero-title-part tenkai" style={{ 
                    fontFamily: 'Orbitron', fontWeight: 900, fontSize: 'clamp(1.8rem, 2.5vw, 2.8rem)', 
                  ...
                  <span className="tk-hero-title-part op" style={{ 
                    fontFamily: 'Outfit', fontWeight: 900, fontSize: 'clamp(3rem, 4.5vw, 4.5rem)', 
              ...
              <div className="tk-hero-actions" style={{ marginTop: '10px', display: 'flex', gap: '15px', alignItems: 'center', flexWrap: 'wrap' }}>
                <button 
                  className="tk-btn-play" 
                  style={{ padding: '12px 24px', fontSize: '1rem' }}
                  onClick={() => window.location.href = '/boutique'}
                >
                  <FaShoppingCart fontSize="1rem" /> ACCÉDER À LA BOUTIQUE
                </button>
        ...
        {/* =========================================
            2. RÉSEAU MUSHI
        ========================================= */}
        <motion.div variants={cardVariants} className="tk-card-mushi" style={{ gridColumn: '9 / span 4', gridRow: '1 / 3', position: 'relative', height: '100%' }}>
        ...
        {/* =========================================
            3. TOP FORTUNE
        ========================================= */}
        <motion.div variants={cardVariants} className="tk-card-fortune" style={{ gridColumn: '1 / span 4', gridRow: '2', position: 'relative', height: '100%' }}>
          <div className="tk-dash-card clickable" onClick={() => setOpenModal('fortune')} style={{ height: '100%', padding: '1.2rem 1.5rem', display: 'flex', alignItems: 'center' }}>
            ...
            <div className="tk-fortune-content" style={{ position: 'relative', zIndex: 20, width: '65%', display: 'flex', flexDirection: 'column', gap: '0.4rem' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <FaCrown color="#00E5FF" fontSize="0.9rem" style={{ filter: 'drop-shadow(0 0 8px rgba(0,229,255,0.6))' }} />
                <div className="tk-tech-font" style={{ color: '#00E5FF', fontSize: '0.75rem', letterSpacing: '3px', fontWeight: 900, textShadow: '0 0 10px rgba(0,229,255,0.4)' }}>TOP FORTUNE</div>
              </div>
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', marginTop: '2px', background: 'rgba(0, 229, 255, 0.1)', border: '1px solid rgba(0, 229, 255, 0.3)', padding: '6px 12px', borderRadius: '12px', boxShadow: 'inset 0 0 20px rgba(0, 229, 255, 0.15)', alignSelf: 'flex-start', backdropFilter: 'blur(8px)' }}>
                <img src="/berry.png" alt="Berry" style={{ width: '18px', height: '18px', filter: 'drop-shadow(0 0 8px rgba(255,215,0,0.6))', animation: 'float 3s ease-in-out infinite' }} onError={(e)=>{e.target.style.display='none';}} />
                <span className="tk-tech-font" style={{ fontSize: '1.2rem', fontWeight: 900, background: 'linear-gradient(180deg, #FFD700 0%, #FFF 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', filter: 'drop-shadow(0 0 10px rgba(255,215,0,0.4))', lineHeight: 1 }}>15,000,000</span>
              </div>
            </div>
            
            <img className="tk-oob-char" src="/render_roger.webp" style={{ position: 'absolute', right: '0%', bottom: '0%', maxHeight: '145%', maxWidth: '50%', width: 'auto', height: 'auto', objectFit: 'contain', objectPosition: 'bottom right', filter: 'drop-shadow(-10px 10px 20px rgba(0,0,0,0.9)) drop-shadow(0 0 25px rgba(0,229,255,0.2))', zIndex: 10, pointerEvents: 'none' }} alt="Roger" onError={(e)=>e.target.style.display='none'} />
          </div>
        </motion.div>
        ...
        {/* =========================================
            4. PRIME LEADERBOARD
        ========================================= */}
        <motion.div variants={cardVariants} className="tk-card-prime" style={{ gridColumn: '5 / span 4', gridRow: '2', position: 'relative', height: '100%' }}>
          <div className="tk-dash-card clickable" onClick={() => setOpenModal('prime')} style={{ height: '100%', padding: '1.2rem 1.5rem', display: 'flex', flexDirection: 'column', justifyContent: 'center', minHeight: 0 }}>
            ...
            <div style={{ position: 'relative', zIndex: 10, display: 'flex', flexDirection: 'column', height: '100%' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '8px' }}>
                 <div style={{ background: 'rgba(0, 229, 255, 0.1)', padding: '6px', borderRadius: '8px', border: '1px solid rgba(0, 229, 255, 0.3)' }}>
                    <FaSkull color="#00E5FF" fontSize="1rem" style={{ filter: 'drop-shadow(0 0 8px rgba(0, 229, 255, 0.6))' }}/>
                 </div>
                 <h3 className="tk-text-metal" style={{ margin: 0, fontSize: '1rem', color: '#FFF' }}>ARCHIVES DES PRIMES</h3>
              </div>
              
              <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-evenly', gap: '6px', flex: 1 }}>
                {topPrimes.slice(0, 3).map((prime) => (
                  <div key={prime.rank} className="tk-data-row" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: prime.bg, border: `1px solid ${prime.border}`, padding: '6px 10px' }}>
                    <style dangerouslySetInnerHTML={{__html:`.tk-data-row-${prime.rank}::before { background: ${prime.color}; }`}} />
                    
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px', overflow: 'hidden' }}>
                      <div className="tk-tech-font" style={{ color: prime.color, fontWeight: 900, fontSize: '0.8rem', width: '16px', textShadow: `0 0 8px ${prime.color}80` }}>#{prime.rank}</div>
                      ...
                      <div className="tk-tech-font" style={{ color: 'var(--text-main)', fontSize: '0.8rem', letterSpacing: '1px', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{prime.name}</div>
                    </div>
                    
                    <div className="tk-tech-font" style={{ display: 'flex', alignItems: 'center', gap: '4px', color: prime.color, fontWeight: 800, fontSize: '0.85rem', flexShrink: 0, textShadow: `0 0 8px ${prime.color}60` }}>
                      {prime.amount} <img src="/berry.png" alt="B" style={{ width: '10px', opacity: 0.8 }} onError={(e)=>e.target.style.display='none'}/>
                    </div>
                  </div>
                ))}
              </div>
        ...
        {openModal && (
          <div style={{ position: 'fixed', inset: 0, zIndex: 3000, display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(1, 2, 5, 0.85)', backdropFilter: 'blur(20px)' }} onClick={() => setOpenModal(null)}>
            <motion.div 
              ...
              style={{ 
                position: 'relative', width: '90%', maxWidth: '550px', height: '70vh', maxHeight: '750px', display: 'flex', flexDirection: 'column', 
