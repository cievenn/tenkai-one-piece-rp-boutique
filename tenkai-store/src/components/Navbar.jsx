...
import { FaShoppingCart, FaHistory, FaHome, FaServer, FaStore } from 'react-icons/fa';
...
export default function Navbar() {
  ...
  const displayName = user?.displayName || user?.discordUsername || 'Pirate';
  ...
  return (
    <nav>
      ...
      <div className="user-actions">
        {!isLoggedIn ? (
          <button className="btn-discord" onClick={login}>
